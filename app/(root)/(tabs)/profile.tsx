    ...
    <SafeAreaView className='h-full bg-white'>
      ...
      >
        ...
        <View className='flex-row justify-center flex mt-5'>
          <View className=' flex felx-col items-center relative mt-5'>
            <Image source={images.avatar} className='size-36 relative rounded-full' />
            <TouchableOpacity className='absolute bottom-11 right-2'>
              <Image source={icons.edit} className='size-5' />
            </TouchableOpacity>
            <Text className='text-2xl font-rubik-bold mt-2'>Ananthu S</Text>
          </View>
        </View>
